...
import com.hao.socket.client.sdk.client.WhSocketSSLConfig;
import com.hao.socket.client.sdk.client.action.IAction;
import com.hao.socket.client.sdk.client.connection.AbsReconnectionManager;
...
import com.hao.socket.common.interfaces.default_protocol.DefaultX509ProtocolTrustManager;
import com.hao.socket.common.interfaces.utils.TextUtils;
...
public class ConnectionManagerImpl extends AbsConnectionManager {
     ...
     * Socket行为监听器
     */
    private com.hao.socket.client.impl.client.action.ActionHandler mActionHandler;
    /**
     * 脉搏管理器
     */
    private volatile com.hao.socket.client.impl.client.PulseManager mPulseManager;
    /**
     * 重新连接管理器
     */
    ...
    private void resolveManager() throws IOException {
        mPulseManager = new com.hao.socket.client.impl.client.PulseManager(this, mOptions);
