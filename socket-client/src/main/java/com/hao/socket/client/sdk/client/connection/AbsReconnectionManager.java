...
public abstract class AbsReconnectionManager implements ISocketActionListener {
    ...
    @Override
    public void onSocketReadResponse(com.hao.socket.client.sdk.client.ConnectionInfo info, String action, OriginalData data) {
        //do nothing;
    }

    @Override
    public void onSocketWriteResponse(com.hao.socket.client.sdk.client.ConnectionInfo info, String action, ISendable data) {
        //do nothing;
    }
