package com.hao.socket.client.sdk.client;
...
import com.hao.socket.client.sdk.client.connection.DefaultReconnectManager;
import com.hao.socket.client.sdk.client.connection.abilities.IConfiguration;
import com.hao.socket.common.interfaces.default_protocol.DefaultNormalReaderProtocol;
...
public class WhSocketOptions implements IIOCoreOptions {
    ...
    public static class Builder {
         ...
         * 安全套接字层配置<br>
         *
         * @param SSLConfig {@link WhSocketSSLConfig}
         */
