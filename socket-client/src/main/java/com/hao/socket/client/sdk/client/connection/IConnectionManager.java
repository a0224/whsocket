...
import com.hao.socket.client.sdk.client.connection.abilities.IConnectable;
...
public interface IConnectionManager extends
     ...
     * @return 连接信息
     */
    com.hao.socket.client.sdk.client.ConnectionInfo getRemoteConnectionInfo();
     ...
     * @return 本地绑定信息
     */
    com.hao.socket.client.sdk.client.ConnectionInfo getLocalConnectionInfo();
     ...
     */
    void setLocalConnectionInfo(com.hao.socket.client.sdk.client.ConnectionInfo localConnectionInfo);
