package com.android.socket.client.impl.client;

import com.android.socket.client.impl.client.action.ActionHandler;
import com.android.socket.core.iocore.interfaces.ISendable;
import com.android.socket.core.utils.SLog;
import com.android.socket.client.impl.client.iothreads.IOThreadManager;
...
import com.android.socket.client.sdk.client.WhSocketSSLConfig;
...
import com.android.socket.common.interfaces.default_protocol.DefaultX509ProtocolTrustManager;
import com.android.socket.common.interfaces.utils.TextUtils;
...
public class ConnectionManagerImpl extends AbsConnectionManager {
     ...
     * socket参配项
     */
    private volatile WhSocketOptions mOptions;
    /**
     * IO通讯管理器
     */
     ...
     * Socket行为监听器
     */
    private com.android.socket.client.impl.client.action.ActionHandler mActionHandler;
    /**
     * 脉搏管理器
     */
    private volatile com.android.socket.client.impl.client.PulseManager mPulseManager;
    /**
     * 重新连接管理器
     */
    ...
    private synchronized Socket getSocketByConfig() throws Exception {
        ...
        //默认操作
        WhSocketSSLConfig config = mOptions.getSSLConfig();
        if (config == null) {
            return new Socket();
        }
    ...
    private void resolveManager() throws IOException {
        mPulseManager = new com.android.socket.client.impl.client.PulseManager(this, mOptions);
    ...
    @Override
    public IConnectionManager option(WhSocketOptions okOptions) {
        if (okOptions == null) {
            return this;
        }
        mOptions = okOptions;
    ...
    @Override
    public WhSocketOptions getOption() {
        return mOptions;
    }
    ...
    public void setIsConnectionHolder(boolean isHold) {
        mOptions = new WhSocketOptions.Builder(mOptions).setConnectionHolden(isHold).build();
    }
