...
import com.android.socket.client.impl.client.PulseManager;
...
import com.android.socket.common.interfaces.common_interfacies.client.IDisConnectable;
import com.android.socket.common.interfaces.common_interfacies.client.ISender;
...
public interface IConnectionManager extends
     ...
     * @return 连接信息
     */
    com.android.socket.client.sdk.client.ConnectionInfo getRemoteConnectionInfo();
     ...
     * @return 本地绑定信息
     */
    com.android.socket.client.sdk.client.ConnectionInfo getLocalConnectionInfo();
     ...
     */
    void setLocalConnectionInfo(com.android.socket.client.sdk.client.ConnectionInfo localConnectionInfo);
