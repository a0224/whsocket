...
import com.hao.socket.common.interfaces.common_interfacies.server.IClientIOCallback;
import com.hao.socket.common.interfaces.common_interfacies.server.IClientPool;
...
//    private IServerManager mServerManager;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        WhSocketOptions.setIsDebug(true);
...
//        mServerManager = WhSocket.server(mPort).registerReceiver(new ServerActionAdapter() {
//            @Override
